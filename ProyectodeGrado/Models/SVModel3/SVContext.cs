namespace ProyectodeGrado.Models.SVModel3
{
    ...
    public partial class SVContext3 : DbContext
    {
        public SVContext3()
            : base("name=SVContext3")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CEDULAS_APROBADAS>()
                .HasMany(e => e.USUARIO)
                .WithRequired(e => e.CEDULAS_APROBADAS)
        ...
        public static implicit operator List<object>(SVContext3 v)
        {
